      ...
      <div className='scrollbar-hide overflow-y-scroll max-h-[95vh] max-w-md my-auto bg-white dark:bg-[#2b2c37] text-black dark:text-white w-full px-8 py-8 rounded-xl'>
        ...
        <div className='flex w-full mt-4 items-center justify-center space-x-4'>
          <button
            ...
            className='w-full items-center text-white hover:opacity-75 bg-red-500 py-2 rounded-full font-semibold'>
            Delete
          </button>
          <button
            onClick={() => setIsDeleteModalOpen(false)}
            className='w-full items-center text-[#635fc7] hover:opacity-75 bg-[#635fc71a] py-2 rounded-full font-semibold'>
            Cancel
          </button>
        </div>
      </div>
